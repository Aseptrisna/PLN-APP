...
public class Adapter_Nama2 extends RecyclerView.Adapter<Adapter_Nama2.MyViewHolder> {
    Context context;
    List<Model_Pln> Menu;

    public Adapter_Nama2 (Context context, List<Model_Pln> Data_Menu) {
    ...
    @NonNull
    @Override
    public Adapter_Nama2.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.list_nama, parent, false);
        Adapter_Nama2 .MyViewHolder holder = new Adapter_Nama2 .MyViewHolder(view);
        return holder;
    }

    @Override
    public void onBindViewHolder(@NonNull Adapter_Nama2 .MyViewHolder holder, int position) {
