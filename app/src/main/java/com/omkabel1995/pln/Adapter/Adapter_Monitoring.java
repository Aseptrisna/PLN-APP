...
import com.omkabel1995.pln.Features.Menu_Verifikasi;
...
public class Adapter_Monitoring extends RecyclerView.Adapter<Adapter_Monitoring.MyViewHolder> implements ViewAsset {
    Context context;
    ...
    public Adapter_Monitoring(Context context, List<Model_DetailAsset> Data_Menu) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.list_monitoring, parent, false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        try {
            ...
            holder.keteranganAsset.setText(Menu.get(position).getKeterangan());
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        holder.verifikasi.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, Menu_Verifikasi.class);
...
//                context.startActivity(intent);
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView status;
        @BindView(R.id.keteranganAsset)
        TextView keteranganAsset;
